...
function displayTopic(data) {
    ...
    for (let i = data.length - 1; i > 0; i--) {
        ...
        <div class="vote">
            ...
            <div class="false" data-msg="${voteChoice2.msg}"><span>${voteChoice2.msg}</span><span class="wrong-choose">${voteChoice2.approve}</span></div>
        </div>
    ...
    axios({
        ...
        .then(res => { // 接口数据
            ...
            if (res.data.msg === "已投票过 投票失败") {
                ...
                console.log(rightAnswer,wrongAnswer, rCount, wCount)
...
function check_comment() {
    ...
    if (this.innerHTML === '查看回复') {
        ...
        for(let i = 0;i<second_comment.length;i++){
            second_comment[i].style.display = 'none'
        }
